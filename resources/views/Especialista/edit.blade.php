...
<div class="form-group">
	...
	<input class="form-control" type="text" name="telefono" id="telefono-field" value="{{ old('telefono', $paciente->telefono ) }}" required maxlength="8" pattern="^[0-9]{8}" title="No se permiten letras en este campo/Debe contener al menos 8 dígitos"/>
</div>
