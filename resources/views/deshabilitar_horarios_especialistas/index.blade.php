...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/dt/dt-1.10.18/datatables.min.css"/>
    ...
    <div class="page-header clearfix">
        <h1>
            ...
            <a class="btn btn-success pull-right" href="{{ route('deshab_especialistas.create') }}"><i class="glyphicon glyphicon-plus"></i> Crear</a>
        </h1>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            @if($deshabilitar_horarios_especialistas->count())
                <table class="table table-condensed table-striped" id="tablaDeshabilitar">
                        <thead>
                                <tr>
