...
<div class="panel panel-primary border-panel">
	...
	<input class="form-control" type="text" name="name" id="name-field" required value="{{ old('name', $cuenta->name) }}" />
    </div> 
    <div class="form-group">
        ...
        ?>
        <input class="form-control" type="text" name="lastName" id="lastName-field" required value="{{ old('lastName', $apellidos[0]) }}" />
    </div>
    <div class="form-group">
            <label for="lastName2-field">Segundo Apellido</label>
            <input class="form-control" type="text" name="lastName2" id="lastName2-field" required value="{{ old('lastName2', $lastName2) }}" />
        </div>
    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
            <label for="email-field">Correo</label>
            <input class="form-control" type="email" name="email" id="email-field" required value="{{ old('email', $cuenta->email) }}" />
            @if ($errors->has('email'))
