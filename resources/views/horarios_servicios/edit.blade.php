...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Horarios_servicio / Edit #{{$horarios_servicio->id}}</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('horarios_servicios.update', $horarios_servicio->id) }}" method="POST">
