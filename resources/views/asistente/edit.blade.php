...
<div class="panel panel-primary border-panel">
 ...
 <div class="form-group">
	...
	<input class="form-control" type="text" name="telefono" id="telefono-field" value="{{ old('telefono', $paciente->telefono ) }}" pattern="^[0-9]{2,48}" title="No se permiten letras en este campo/ingresar al menos 8 digitos"/>
</div>
