        ...
        <div class="col-md-12">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-condensed table-hover" id='tablaDatos'>
                    <thead>
                        <tr>
                            <th class="text-center">Especialista</th> <th class="text-center">Dia bloqueado</th> <th class="text-center">Fecha inicio</th> <th class="text-center">Fecha fin</th> <th class="text-center">Hora inicio</th> <th class="text-center">Hora fin</th>
