...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<div class="tittle serif" style="color:#FFFFFF; margin-top:7px;" >Administrador Servicio de Salud</div>
			...
			<div id="sidebar-wrapper" class="sidebar-toggle sidebar">
				...
				<ul class="sidebar-nav">
		    		<li>
		      			<a style="font-size:15px;" class="border" href="admin">Inicio<span class="glyphicon glyphicon-home right-aling-glyphicon"></span></a>
		    		</li>
		    		<li>
		      			<a style="font-size:15px;" class="border" href="cuentas">Cuentas<span class="glyphicon glyphicon-user right-aling-glyphicon"></a>
		    		</li>
		    		<li>
		      			<a style="font-size:15px;" class="border" href="horarios">Horarios<span class="glyphicon glyphicon glyphicon-wrench right-aling-glyphicon"></a>
		    		</li>
		    		<li>
		      			<a style="font-size:15px;" class="border" href="servicios">Servicios<span class="glyphicon glyphicon-list-alt right-aling-glyphicon"></a>
		    		</li>
		    		<li>
		      			<a  style="font-size:15px;"class="border" href="recintos">Recintos<span class="glyphicon glyphicon-flag right-aling-glyphicon"></a>
		    		</li>
