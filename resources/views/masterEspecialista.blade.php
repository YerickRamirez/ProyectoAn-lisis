...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	...
	<div class="sidebar-mobile">       
      ...
      <div id="myNavbar">
		...
		<a class="border-a" href="{{ route('Especialista.menuConfigHorarios') }}">Horario<span class="glyphicon glyphicon-time right-hora-e"></a>
...
<!--	@if (Route::has('login'))
	...
	<script src="{{asset('js/masterEspecialista.js')}}"></script>
</body>
