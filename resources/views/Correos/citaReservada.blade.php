...
<div>
    <p>Estimado(a) {{$name}}.</p>
    <p>El Servicio de Salud, Sede de Occidente de la Universidad de Costa Rica le informa que su cita para las {{$hora}} del día  {{$fecha}} ha sido reservada con éxito, 
