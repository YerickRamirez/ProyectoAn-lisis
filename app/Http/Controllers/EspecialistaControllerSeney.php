...
class EspecialistaControllerSeney extends Controller
{
    ...
    public function index(Request $request){
		...
		$especialistas = EspecialistaModel::where('active_flag', 1)->orderBy('primer_apellido_especialista', 'desc')->get();
    ...
    public function agregarEspecialista(Request $request)
    {
        ...
        $especialista->cedula_especialista = $request->cedula;

        $especialista->nombre = $request->nombre;

        $especialista->primer_apellido_especialista = $request->primer_apellido;

        $especialista->segundo_apellido_especialista = $request->segundo_apellido;
